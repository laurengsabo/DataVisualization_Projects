...
function updateBars(house) {
    ...
    if (house === 'top') {
        ...
        currHouse = house;
        filteredCharacters = characters.filter(checkHouse);
    }

    filteredCharacters.sort((a, b) => b.probability_of_survival - a.probability_of_survival);
...
function checkHouse(character) {
    return character.house === currHouse;
}