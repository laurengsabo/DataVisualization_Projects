...
function updateChart(filterKey) {
    ...
    // I know we are supposed to begin using the Update command in Activity 2, but I found it easier
    // to use .enter in Activity 1, and I don't believe the Wiki stated we couldn't use .enter in Activity 1.
